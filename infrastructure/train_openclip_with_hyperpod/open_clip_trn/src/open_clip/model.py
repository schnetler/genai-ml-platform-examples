...
class CLIP(nn.Module):
    ...
    def encode_text(self, text, normalize: bool = False, batch_size=None):
        ...
        x, _ = text_global_pool(x, text, self.text_pool_type, batch_size=batch_size)
    ...
    def forward(
        ...
        text_features = self.encode_text(text, normalize=True, batch_size=batch_size) if text is not None else None
