...
def generate_podcast(
    ...
    create_dialogue_audio(llm_output.dialogue, "dialogue_output.mp3", tts_model)
...
demo = gr.Interface(
    ...
    inputs=[
        ...
        gr.Dropdown(
            label=UI_INPUTS["tts_model"]["label"],
            choices=UI_INPUTS["tts_model"]["choices"],
            value=UI_INPUTS["tts_model"]["value"],
        ),
        gr.File(
            ...
            elem_id="video_upload",  # Add an element ID for styling
            scale=0.7,  # Reduces the width to 50% of the container
            min_width=200,  # Sets minimum width in pixels
            height=100,  # Sets height in pixels
        ),
        gr.File(
            ...
            elem_id="file_upload",  # Add an element ID for styling
            scale=0.7,  # Reduces the width to 50% of the container
            min_width=200,  # Sets minimum width in pixels
            height=100,  # Sets height in pixels
        ),
