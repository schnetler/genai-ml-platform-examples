...
// AWS logo as SVG icon
const AWSIcon = (props: any) => (
  <SvgIcon {...props} viewBox="0 0 304 182">
    <path
      ...
      <Container maxWidth="lg">
        <Toolbar disableGutters>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <FlightTakeoffIcon sx={{ display: { xs: 'none', md: 'flex' }, mr: 1, color: 'secondary.main' }} />
            <Typography
              variant="h6"
              noWrap
          ...
          <Box sx={{ display: { xs: 'flex', md: 'none' }, alignItems: 'center' }}>
            <FlightTakeoffIcon sx={{ display: { xs: 'flex', md: 'none' }, mr: 1, color: 'secondary.main' }} />
            <Typography
              variant="h6"
              noWrap
              component={RouterLink}
